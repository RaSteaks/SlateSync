...
# Migrated provenance, coverage, prompt and missing-execution negative cases.
assert_success "native acceptance and provenance negative tests" \
  python3 -B "${project_root}/script/tests/sm09_native_contract.py" --self-test
...
# Admission timing remains enforced by the shared JSON validator above;
# no interpreter from the removed build system is needed for this boundary.

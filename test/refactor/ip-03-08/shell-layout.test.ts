...
describe("application shell layout", () => {
  it("uses the packaged App Icon as the sidebar brand mark", async () => {
    ...
    // Importing the canonical v5 asset keeps the renderer brand mark aligned
    // with the raster embedded in the macOS Icon Composer package.
    expect(source).toContain('import appIconUrl from "../../assets/slatesync-icon-v5.png"');

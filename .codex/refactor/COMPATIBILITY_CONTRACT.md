...
Release metadata amendment (2026-09-20): the live Electron application version
is `1.1.0`, released under the architecture-qualified tag
`v1.1.0-electron`; frozen baseline fixtures and historical validation records
retain the versions captured when they were produced.

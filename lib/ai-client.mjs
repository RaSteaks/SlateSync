...
export async function recognizeSlate(
  ...
  const customContext = withCustomPrompt(SYSTEM_PROMPT, customPrompt, slateCsvContext);
  const auditContext = withCustomPrompt(CORE_AUDIT_SYSTEM_PROMPT, customPrompt, slateCsvContext);
  const reviewContext = withCustomPrompt(CORE_REVIEW_SYSTEM_PROMPT, customPrompt, slateCsvContext);
  const pdfContext = withCustomPrompt(PDF_SYSTEM_PROMPT, customPrompt, slateCsvContext);

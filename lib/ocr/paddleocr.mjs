...
//
// Spawns the canonical native PaddleOCR resource over stdout JSON
...
import { paddleResourceDir, runtimeProjectDir } from "./runtime-paths.mjs";
...
function paddleRunnerPath(env = process.env) {
  return join(paddleResourceDir(env), "paddleocr_runner.py");
}

// Server request validation guards.
//
// Rejects requests that are not application/json, that carry a cross-site
// fetch signature, or whose Origin does not match the Host, so the local
// SlateSync API only answers same-origin callers.
